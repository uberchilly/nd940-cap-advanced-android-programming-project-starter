...
class RepresentativeListAdapter(private val clickListener: RepresentativeListener? = null) :
...
class RepresentativeViewHolder(private val binding: ItemRepresentativeBinding) :
    ...
    fun bind(item: Representative, clickListener: RepresentativeListener?) {
        ...
        binding.officeTextView.text = item.office.name
        binding.officialTextView.text = item.official.name
        binding.affiliationTextView.text = item.official.party

        fetchImage(binding.profileImageView, item.official.photoUrl)
